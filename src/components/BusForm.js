    ...
    try {
      ...
      if (type === "add") {
        response = await axiosInstance.post(
          "https://busbuddy-application.onrender.com/api/buses/add-bus",
          values
        );
      } else {
        response = await axiosInstance.put(
          "https://busbuddy-application.onrender.com/api/buses/update-bus",
          {
            ...values,
            _id: selectedBus._id,
          }
        ...
        <Row gutter={[10, 10]}>
          ...
          <Col lg={12} xs={24}>
            <Form.Item label="Type" name="type">
              <select name="Select AC Type" id="type">
